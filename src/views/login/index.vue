...
<el-row class="row">
  ...
  <el-col :span="12" :xs="24">
    ...
    <h1>HELLO</h1>
    <h2>欢迎来到硅谷甄选</h2>
  <el-form class="form" label-width="50px"  :model="ruleForm" status-icon :rules="rules" ref="ruleFormRef" >
    <el-form-item label="账号:" prop="username">
      <el-input prefix-icon="User" v-model="ruleForm.username"   />
    </el-form-item>
    <el-form-item label="密码:" prop="password">
      <el-input prefix-icon="lock"  v-model="ruleForm.password" type="password" show-password="true" />
    </el-form-item>
    <el-form-item >
      <el-button class="form_button" @click="submitForm(ruleFormRef)">登录</el-button>
    </el-form-item>
  </el-form>
    </div>
  </el-col>
...
// 密码校验器
const validatePassword=(rele:any,value:any,callback:any)=>{
  if(value==='')
{
